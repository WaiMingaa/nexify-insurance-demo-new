...
, 'bot');
updateMessage("<div class=\"ui vertical buttons\"><button id=\"sing\" class=\"ui secondary button\">新加坡+馬來西亞5天皇牌之旅</button><button id=\"thai\" class=\"ui secondary button\">曼谷+芭堤雅5天抵玩之旅</button><button id=\"taw\" class=\"ui secondary button\">台北4天超值之旅 </button><button id=\"nothanks\" class=\"ui button\">不用了，謝謝</button></div>",'user');
...
return '<div class=\"ui segment\">'+strVar+Str+sub+'</div>';
            ...
            $("#subtravel").on("click",function(){
              $("#subtravel").parent().parent().html("表格已傳送");
...
function getDate( element ) {
 ...
 return date;
        ...
        case 'casenumber':
            ...
            break;
            case 'sellplan':
            updateMessage("<div class=\"ui  card\" data-html=\"<div class='header'>User Rating<\/div><div class='content'><div class='ui star rating'><i class='active icon'><\/i><i class='active icon'><\/i><i class='active icon'><\/i><i class='icon'><\/i><i class='icon'><\/i><\/div><\/div>\">   <div class=\"image\">     <img src=\".\/img\/chi.jpg\">   <\/div>   <div class=\"content\">     <div class=\"header\">The Combined Lake and River Tour<\/div>     <div class=\"description\">HKD2,499+     <\/div>   <\/div>   <\/div>",'bot');
              updateMessage("<button id=\"okay\" class=\"ui secondary button\">需要</button><button id=\"nothanks\" class=\"ui button\">不用</button>",'user');
              $("#okay").on("click",function(){
                $("#okay").parent().parent().remove();
              ConversationHandler.setRequestParam("感謝你的興趣，已為你留位");
              sendMessage();
              })
              $("#nothanks").on("click",function(){
                $("#nothanks").parent().parent().remove();
                ConversationHandler.setRequestParam("不用了");
                sendMessage();
              })
              break;
              case 'listofhotel':
...
ConversationHandler.setRequestParam("表格已傳送");
...
sendMessage();
              ...
              break;
              case 'bookhotel':
                updateMessage("<button id=\"okhotel\" class=\"ui secondary button\">需要</button><button id=\"nohotel\" class=\"ui button\">不用</button>",'user');
                $("#okhotel").on("click",function(){
                  $("#okhotel").parent().parent().remove();
                ConversationHandler.setRequestParam("無錯，我要訂酒店");
                sendMessage();
                })
