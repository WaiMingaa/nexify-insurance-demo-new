...
chatapp.service('MessageBuilder',function(TimeHandler,$q){
  ...
  this.genUserMessage=function(word) {
    return '<div class="row"> <div class="col-md-7 col-md-offset-5"><li class=\"self-right\"><span class="timetext-right">' +
          TimeHandler.getCurrentTime() + '</span><div class="bubble-right"><div class="ui fluid segment style"width:280px;">' + word + '</div></div><img style="width:70x;height:50px;" src="./img/usericon.png" aria-hidden="true"></img></li></div></div>';
  }
})
